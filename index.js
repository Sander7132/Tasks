    ...
    const tasks = [
        ...
        {id: 2, userId: 1, title: 'Buy eggs', done: false},
        {id: 3, userId: 1, title: 'Buy bread', done: false} 
    ...
    app.delete('/tasks/:id', authorizeRequest, (req, res) => {
        ...
        if (tasks[taskIndex].userId !== req.user.id) return res.status(403).send('Forbidden');
